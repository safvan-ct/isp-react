  ...
  return (
    <div style={{ backgroundColor: 'var(--desert-sand)', minHeight: '80vh' }}>
      <main className="container py-4 text-start">
        ...
        <section className="courses-header-banner mb-5 shadow-sm text-start">
          <div className="row align-items-center g-4">
            <div className="col-lg-7">
              ...
              <h1 className="display-6 fw-bold mb-3">Sacred Knowledge & Learning Tracks</h1>
              <p className="mb-0 opacity-75 lead" style={{ fontSize: '1.05rem' }}>
                From fundamental creed and Islamic history to prophetic character and legal jurisprudence,
                embark on a progressive journey guided by classical manuscripts and traditional scholarship.
              </p>
            </div>
            <div className="col-lg-5 text-lg-end text-start">
              <div className="d-flex flex-column gap-2 align-items-lg-end">
                <div 
                  ...
                  style={{ maxWidth: '320px', borderColor: 'rgba(194, 150, 83, 0.3) !important' }}
                >
                  <i className="bi bi-award-fill text-warning fs-2"></i>
                  <div className="text-start">
                    <h6 className="fw-bold mb-0">Ijazah & Certifications</h6>
                    <small className="opacity-75">Verified completion tracks</small>
                  </div>
                </div>
                <div 
                  className="d-flex align-items-center gap-3 bg-dark bg-opacity-50 p-3 rounded-3 border border-secondary"
                ...
                >
                  ...
                  <div className="text-start">
                    ...
                    <small className="opacity-75">Interactive weekly sessions</small>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="featured-program-card mb-5 shadow-sm">
          <div className="row align-items-center g-4">
            <div className="col-lg-8">
              <div className="d-flex align-items-center gap-2 mb-2 flex-wrap">
                <span className="badge" style={{ backgroundColor: 'var(--desert-terracotta)', color: '#fff' }}>
                  Featured Diploma
                </span>
                <span className="badge bg-outline-dark border">Enrollment Closing Soon</span>
              </div>
              <h3 className="fw-bold mb-2">Usul al-Fiqh: Principles of Islamic Jurisprudence & Legal Maxims</h3>
              <p className="text-muted mb-3">
                An in-depth exploration of how classical jurists derived rulings from primary sources (Quran &
                Sunnah), examining consensus (Ijma'), analogical deduction (Qiyas), and legal maxims (Al-Qawa'id
                al-Fiqhiyyah).
              </p>
              <div className="d-flex flex-wrap align-items-center gap-4 text-muted small">
                <span>
                  <i className="bi bi-person me-1" style={{ color: 'var(--desert-terracotta)' }}></i> Instructor:
                  <strong> Shaykh Dr. Tariq Al-Mansoor</strong>
                </span>
                <span>
                  <i className="bi bi-calendar3 me-1" style={{ color: 'var(--desert-terracotta)' }}></i> Duration:
                  <strong> 12 Weeks</strong>
                </span>
                <span>
                  <i className="bi bi-clock me-1" style={{ color: 'var(--desert-terracotta)' }}></i> Effort:
            ...
            <div className="col-lg-4 text-lg-end border-lg-start ps-lg-4 text-start">
              ...
              <p className="small text-muted mb-3">Includes syllabus PDF & manuscript notes</p>
              <button className="btn btn-desert-primary w-100 py-2 d-block" disabled>
        ...
        <div className="row g-4" id="coursesList">
          {filteredCourses.length === 0 ? (
            <div className="col-12 text-center py-5">
              ...
              <p className="text-muted mt-3">No courses match your query or selected discipline.</p>
            </div>
          ) : (
                ...
                <div className="course-card h-100 d-flex flex-column justify-content-between">
                  <div>
                    <div className="course-thumb-container">
                      <span className={`level-badge badge-${course.level.toLowerCase().replace(' ', '-')}`}>
                        {course.level}
                      </span>
                      <div className="course-thumb-icon">
                        <i className={`bi ${course.icon}`}></i>
                      </div>
                      <span className="course-arabic-tag">{course.arabicTag}</span>
                    </div>
                    <div className="course-body">
                      <div className="course-meta mb-2">
                        <span className="me-3"><i className="bi bi-clock me-1"></i> {course.duration}</span>
                        <span><i className="bi bi-journal-text me-1"></i> {course.modules}</span>
                      </div>
                      ...
                      >
                        <div className="d-flex align-items-center gap-2">
                          <div className="instructor-avatar">{course.avatar}</div>
                          <small className="text-muted fw-semibold">{course.instructor}</small>
                        </div>
                        <button 
