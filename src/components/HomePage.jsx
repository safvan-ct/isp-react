...
export default function HomePage() {
	...
	return (
		<div>
					...
					<div className="row align-items-center g-5">
						<div className="col-lg-6">
							<span className="badge badge-desert mb-3">
								<i className="bi bi-stars me-1"></i> Authentic • Classical •
								Accessible
							</span>
							<h1 className="display-4 fw-bold lh-sm mb-3 text-dark">
								Illuminating Minds With The{" "}
								<span style={{ color: "var(--desert-terracotta)" }}>
									Timeless Word
								</span>
							</h1>
							<p
							...
							>
								Delve into Quranic sciences, authentic Hadith commentary, and
								classical Arabic guided by traditional scholarship in a modern
								digital space.
							</p>
							<div className="d-flex flex-nowrap gap-3">
								<Link
									to="/courses"
									className="btn btn-desert-primary text-decoration-none btn-mb"
								>
									<i className="bi bi-compass me-1"></i> Start Learning
								</Link>
								<Link
									to="/quran"
									className="btn btn-desert-outline text-decoration-none btn-mb"
								>
							...
							{/* Quick Stat Counters */}
							<div
								className="row mt-3 pt-3 border-top g-3"
						...
						<div className="col-lg-6">
							<div className="verse-card p-4 p-md-5 shadow-lg">
								...
								<div className="pt-3 border-top border-secondary d-flex justify-content-between align-items-center">
									...
									>
										<i
											className={`bi ${isPlayingAyah ? "bi-pause-fill" : "bi-volume-up-fill"} me-1`}
										></i>
			...
			<section className="py-3" id="courses">
				<div className="container">
					<div className="text-center max-w-lg mx-auto mb-5">
						...
						<h2 className="display-6 fw-bold mt-1 text-dark">
							Disciplines of Sacred Knowledge
						</h2>
						<p className="text-muted">
							Curated curriculums spanning foundational basics to advanced
							classical texts.
						</p>
					</div>
							...
							<div className="arch-card h-100 d-flex flex-column justify-content-between">
								<div>
									...
									<p className="text-muted small mb-4">
										Master Quranic phonetics, makharij, and rules of recitation
										with live corrections.
									</p>
								</div>
								<button
									className="btn btn-sm btn-desert-outline w-100"
									disabled
								>
									Coming Soon
								</button>
						...
						<div className="col-md-6 col-lg-3">
							<div className="arch-card h-100 d-flex flex-column justify-content-between">
								<div>
									...
									<p className="text-muted small mb-4">
										Historical contexts, linguistic depths, and practical
										reflections of each Surah.
									</p>
								</div>
								<button
									className="btn btn-sm btn-desert-outline w-100"
						...
						<div className="col-md-6 col-lg-3">
							<div className="arch-card h-100 d-flex flex-column justify-content-between">
								<div>
									...
									<p className="text-muted small mb-4">
										Grammar (Nahw) and morphology (Sarf) geared directly to
										comprehending the Revelation.
									</p>
								</div>
								<Link
									to="/courses/arabic"
									className="btn btn-sm btn-desert-outline w-100 text-decoration-none"
								>
									Explore Track
								</Link>
							</div>
						...
						<div className="col-md-6 col-lg-3">
							<div className="arch-card h-100 d-flex flex-column justify-content-between">
								<div>
									...
									<p className="text-muted small mb-4">
										Study the Prophetic character and traditions (Nawawi 40,
										Riyad us-Saliheen).
									</p>
								</div>
								<Link
									to="/courses/hadith-seerah"
									className="btn btn-sm btn-desert-outline w-100 text-decoration-none"
								>
									Explore Track
								</Link>
			...
			<section
				className="py-5 bg-desert"
				style={{ backgroundColor: "var(--desert-dune)" }}
			>
				<div className="container">
					<div className="row g-4 align-items-center text-start">
						<div className="col-lg-5">
							...
							<h3 className="fw-bold text-dark">
								Your Daily Spiritual Cadence
							</h3>
							<p className="text-muted">
								Integrate steady, manageable milestones into your daily routine.
								Consistent steps turn learning into lifelong habit.
							</p>
							<div className="d-flex flex-column gap-2 mt-3">
								<div className="d-flex align-items-center gap-2">
									<i
										className="bi bi-check2-circle fs-5"
										style={{ color: "var(--desert-terracotta)" }}
									></i>
									<span className="fw-medium text-dark">
										Audio recitation speed control and repeat loops
									</span>
								</div>
								<div className="d-flex align-items-center gap-2">
									<i
									...
									></i>
									<span className="fw-medium text-dark">
										Downloadable PDF summaries with vocabulary roots
									</span>
								</div>
								<div className="d-flex align-items-center gap-2">
									<i
									...
									></i>
									<span className="fw-medium text-dark">
										Ad-free Quran reader with line-by-line notes
									</span>
								</div>
							</div>
						</div>
						...
						<div className="col-lg-7">
							<div
								className="daily-tracker-card shadow-sm text-start"
								style={{
							...
							>
								<div className="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
									<div>
										...
										<small className="text-muted">
											Track your reading & memorization progress
										</small>
									</div>
									<span className="badge bg-warning text-dark">
										<i className="bi bi-fire me-1"></i> 7 Days Active
									</span>
								</div>
								...
								>
									<div className="d-flex justify-content-between small text-muted mb-1">
										<span>
											Current Juz: <strong>Juz 30 ('Amma)</strong>
										</span>
								...
								<div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
									<span className="small text-muted">
										<i className="bi bi-clock me-1"></i> Next live session:
										Today, 8:00 PM
									</span>
									<Link to="/quran" className="btn btn-sm btn-desert-primary">
										Open Reader
									</Link>
								</div>
							</div>
